  ...
  return (
    <div align="center">
      ...
      <img src="./icons/Line.png" class="line"></img>
          ...
          <div className="faqstable" align="center">
            <div className="row">
              ...
              <p onClick={() => setFaqbox2(!faqbox2)}>
                <b> What are the tests about? </b>
                  ...
                  <p className="faq1">
                    There are two tests:
                    <br />
                     A General Test that identifies your strength and
              ...
              <p onClick={() => setFaqbox3(!faqbox3)}>
                <b> Is it free? </b>
                  ...
                  <p className="faq1">
                    EduGuide is a free app. <br />  Create an account to
                    take the test. <br />  Make the right decision.
                  </p>
      ...
      {/* gumawa na lang ako ng ibang form layout para sa mobile */}
