  ...
  return (
    <body>
      <div align="center">
        ...
        >
          {data?.getGeneralTestSets?.map((item, index) => (
            <div
              style={{
                width: "30%",
                padding: 20,
              ...
              onClick={() => history.push("/edit-gen-test-set", { data: item })}
            >
...
export default EditGenTestSetsList;
